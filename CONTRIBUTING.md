...
Contributions to **FlorianWolters\Component\Core\StringUtils** are always welcome.
...
Run the following commands to initially checkout **FlorianWolters\Component\Core\StringUtils**:
